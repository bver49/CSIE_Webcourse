...
class Admin::PostsControllerTest < ActionController::TestCase
  ...
  test "should create admin_post" do
    assert_difference('Admin::Post.count') do
      post :create, admin_post: { itemtype: @admin_post.itemtype, place: @admin_post.place, status: @admin_post.status, title: @admin_post.title }
    end
  ...
  test "should update admin_post" do
    patch :update, id: @admin_post, admin_post: { itemtype: @admin_post.itemtype, place: @admin_post.place, status: @admin_post.status, title: @admin_post.title }
    assert_redirected_to admin_post_path(assigns(:admin_post))
  end
